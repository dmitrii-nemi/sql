...
CREATE TABLE `users` (
  ...
  `name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Имя пользователя',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-02-05  8:10:52
...
-- Dump completed on 2020-02-05  9:05:10
